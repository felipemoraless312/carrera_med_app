            ...
            <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:bg-white/15 hover:scale-105">
              ...
              <div className="mt-8 space-y-4">
                <button
                  ...
                  className="group w-full bg-red-700 hover:bg-red-800 text-gray-100 py-5 px-6 rounded-2xl text-xl font-black transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-blue-900/40 relative overflow-hidden"
                >
