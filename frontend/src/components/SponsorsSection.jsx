    ...
    <div className="py-16 bg-blue-950">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-16">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 md:gap-3 place-items-center max-w-6xl w-full">
            {sponsors.map((sponsor, index) => (
              <div 
                key={`${sponsor.name}-${index}`} 
                className="flex flex-col items-center justify-center text-center px-1 py-1 transition-all duration-300 hover:scale-105"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full overflow-hidden border border-blue-700 bg-blue-800 shadow-inner mb-2">
                  <img 
                ...
                <p className="text-[9px] sm:text-[10px] font-semibold text-gray-200 text-center leading-tight max-w-[110px]">
                  {sponsor.name}
                </p>
              </div>
            ))}
